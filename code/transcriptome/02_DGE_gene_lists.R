...
## IF already done, skip ahead to line 54 (read table in instead)
...
write.csv(sig_genes_adj_1, file="results/transcriptome/RNA_genes_p<0.05.csv") 
write.csv(sig_genes_permissive_adj_1, file="results/transcriptome/RNA_genes_p<0.1.csv") 
