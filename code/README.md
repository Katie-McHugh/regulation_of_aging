...
4) 03_uncorrected_heatmap.R is a script visualizing the same heatmap, but without ComBatseq batch correction (used in supplementary figure). It also creates Supplementary Figures 3 A and C (uncOrrected PCA).
